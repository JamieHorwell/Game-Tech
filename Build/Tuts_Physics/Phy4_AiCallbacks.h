...
public:
	...
	virtual void OnInitializeScene() override
	{
		...
		PhysicsEngine::Instance()->getBPcull().init(Vector3(-20, 0, -20), Vector3(20, 10, 20));
		...
		player->Physics()->SetBroadphaseShape(new SphereCollisionShape(Vector3(0.5f,0.5f,1.0f).Length()));
		player->Physics()->AddColShape(new CuboidCollisionShape(Vector3(0.3f, 0.3f, 0.3f), Vector3(0.0f,0.3f,-0.4f)));
		player->Physics()->AddColShape(new CuboidCollisionShape(Vector3(0.3f, 0.3f, 0.3f), Vector3(0.0f, 0.1f, 0.1f)));
		...
		city1->Physics()->AddColShape(new CuboidCollisionShape(col_size1));
		city1->Physics()->SetOnCollisionCallback(&Phy4_AiCallbacks::ExampleCallbackFunction1);
		city1->Physics()->SetBroadphaseShape(new SphereCollisionShape(col_size1.Length()));
		...
		city2->Physics()->AddColShape(new CuboidCollisionShape(col_size2));
		...
		city2->Physics()->SetBroadphaseShape(new SphereCollisionShape(col_size2.Length()));
		...
		nde->AddColShape(new SphereCollisionShape(1.0f));
		nde->SetBroadphaseShape(new SphereCollisionShape(1.0f));
