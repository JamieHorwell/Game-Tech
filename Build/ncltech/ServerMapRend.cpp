...
ServerMapRend::ServerMapRend(ServerMazeGenerator* gen)
	: GameObject("")
	, maze(gen)
	, flat_maze(NULL)
{
...
void ServerMapRend::DrawSearchHistory(const SearchHistory& history, float line_width)
{
...
uint ServerMapRend::Generate_FlatMaze()
{
...
void ServerMapRend::Generate_ConstructWalls()
{
...
void ServerMapRend::Generate_BuildRenderNodes()
{
