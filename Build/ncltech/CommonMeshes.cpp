...
GLuint    CommonMeshes::m_pCheckerboardTex;
...
void CommonMeshes::InitializeMeshes()
{
	...
	if (m_pCube == NULL)
	{
		m_pCheckerboardTex = SOIL_load_OGL_texture(TEXTUREDIR"checkerboard.tga", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
