...
struct GraphNode
{
	...
	bool operator==(const GraphNode &A)const { return (A._pos.x == _pos.x && A._pos.y == _pos.y && A._pos.z == _pos.z) ? true : false; };
};
...
class ServerSearchAlgorithm
{
public:
	ServerSearchAlgorithm() {	}
	virtual ~ServerSearchAlgorithm() {}
