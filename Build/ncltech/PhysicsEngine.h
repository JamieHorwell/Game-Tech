...
#define DEBUGDRAW_FLAGS_BROADPHASESHAPES		0x10
#define DEBUGDRAW_FLAGS_BROADPHASEOCT			0x20
...
public:
	...
	inline float getMinVel() { return minVel; };
	inline float getMaxVel() { return maxVel; };
	...
	void setCloth(Cloth* cloth) { this->cloth = cloth; };
