...
ServerMazeGenerator::ServerMazeGenerator()
	: size(0)
	, start(NULL)
	, end(NULL)
	, allNodes(NULL)
...
void ServerMazeGenerator::Generate(int grid_size, float maze_density)
{
	if (allNodes != nullptr)
	{
		delete[] allNodes;
...
void ServerMazeGenerator::GetRandomStartEndNodes()
{
...
void ServerMazeGenerator::Initiate_Arrays()
{
...
void  ServerMazeGenerator::Generate_Prims()
{
...
void ServerMazeGenerator::Generate_Sparse(float density)
{
